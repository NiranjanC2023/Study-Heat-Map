...
git init -b main
git add -A
git commit -m "Initial commit: Focus Flow Chrome extension"
echo ""
echo "Next — push to GitHub (no extra tools required):"
echo "  1. On github.com: New repository → name it (e.g. Focus-Flow) → leave it EMPTY (no README)."
...
echo "  gh repo create Focus-Flow --public --source=. --remote=origin --push"
